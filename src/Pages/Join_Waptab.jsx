          ...
          <div className="-mx-4 flex flex-wrap justify-center lg:px-24 md:px-6 px-5">
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div className="mb-10  hover:shadow-2xl overflow-hidden rounded-[10px] border-2 border-stroke  dark:border-dark-3 bg-white dark:bg-dark-2 py-10 px-8 shadow-pricing sm:p-12 lg:py-10 lg:px-6 xl:p-[50px]">
                ...
                <h2 className="mb-5 text-[42px] font-bold font-[Montserrat] text-black">
                  <span>1,500</span>
                          ...
                          <div class="relative py-3 lg:px-0 md:px-0 px-3 sm:max-w-xl sm:mx-auto">
                            ...
                            <div class="relative px-4 py-1 rounded-lg bg-white shadow-lg sm:rounded-3xl">
                              ...
                              <div class="max-w-md mx-auto ps-10 pe-10 pb-10">
                                <div>
                                  <h1 class="text-2xl pb-3 text-center font-[Montserrat] font-semibold">
                                    Join WAPTAB
                                  </h1>
                                </div>
                                <div class="divide-y divide-gray-200">
                                  ...
                                  >
                                    <div class="relative z-0 w-full font-[Montserrat] mb-5 group">
                                      <input
                                        type="text"
                                        name="Name"
                                        value={formData.Name}
                                    ...
                                    <div class="relative z-0 w-full mb-5 group font-[Montserrat]">
                                      ...
                                      <label
                                        ...
                                        class="peer-focus:font-medium absolute text-sm text-blue-500 dark:text-gray-400 font-medium duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 "
                                      >
                                        Membership Type
                                      </label>
                                    </div>
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div className=" mb-10  hover:shadow-2xl overflow-hidden rounded-[10px] border-2 border-stroke dark:border-dark-3 bg-white dark:bg-dark-2 py-10 px-8 shadow-pricing sm:p-12 lg:py-10 lg:px-6 xl:p-[50px]">
                ...
                <h2 className="mb-5 text-[42px] font-[Montserrat] font-bold text-black">
                  <span>5,000</span>
                  <span className="text-base font-medium text-body-color dark:text-dark-6">
                    INR/ 3 Years
                  </span>
                        ...
                        <div class="py-6 lg:px-6 md:px-0 px-2 sm:py-12">
                          <div class="relative py-3 lg:px-0 md:px-0 px-3 sm:max-w-xl sm:mx-auto">
                            ...
                            <div class="relative px-4 py-1 rounded-lg bg-white shadow-lg sm:rounded-3xl">
                              ...
                              <div class="max-w-md mx-auto ps-10 pe-10 pb-10">
                                <div>
                                  <h1 class="text-2xl pb-3 font-[Montserrat] text-center font-semibold">
                                    Join WAPTAB
                                  </h1>
                                </div>
                                <div class="divide-y divide-gray-200">
