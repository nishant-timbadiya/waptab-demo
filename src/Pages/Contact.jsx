        ...
        <div className="px-10 md:px-28 lg:px-64 pt-10 pb-5">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-1 lg:gap-20 md:gap-12 gap-10 ">
            <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] hover:shadow-2xl hover:cursor-pointer">
              ...
              <h4 className="text-[#333] text-base font-extrabold mt-4">
                Visit office
              </h4>
              <p className="text-sm tect-gray-400 mt-2">
            ...
            <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] hover:shadow-2xl hover:cursor-pointer">
              ...
              <p className="text-sm tect-gray-400 mt-2">info@waptag.org</p>
            </div>
          </div>
        </div>
      </div>

      <div className="center-box lg:mx-40 md:mx-20 mx-5">
        <div className="grid lg:grid-cols-3 items-center max-lg:justify-center h-full py-6 px-16 max-sm:px-4 bg-slate-100 font-[sans-serif]">
          <div className="max-w-lg max-lg:mx-auto max-lg:text-center max-lg:mb-6">
            <h2 className="text-4xl font-extrabold text-[#333] px-2">
              Contact Us
            </h2>
            <p className="text-sm text-[#333] mt-4 px-2">
          ...
          <div class="z-10 relative lg:col-span-2">
            <img src="https://readymadeui.com/contact.webp" class="w-full" />
          </div>
        </div>
      </div>
      <ToastContainer />
